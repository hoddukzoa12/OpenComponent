...
function Questionnaire({
  ...
  return (
    <QuestionnairePrimitive.Root
      ...
      className={cn('gap-4 cn-questionnaire flex w-full min-w-0 flex-col', className)}
      {...props}
    />
  )
}
...
function QuestionnaireTitle({
  ...
  return (
    <QuestionnairePrimitive.Title
      ...
      className={cn(
        'text-lg font-semibold cn-questionnaire-title cn-font-heading text-pretty',
        className,
      )}
      {...props}
    />
...
function QuestionnaireChoices({
  ...
  return (
    <QuestionnairePrimitive.Choices
      ...
      className={cn(
        'gap-2 my-4 cn-questionnaire-choices group/questionnaire-choices grid min-w-0',
        className,
      )}
      {...props}
    />
...
function QuestionnaireChoice({
  ...
  return (
    <QuestionnairePrimitive.Choice
      ...
      className={cn(
        'gap-3 rounded-md border p-3 has-focus-visible:ring-2 has-focus-visible:ring-ring data-checked:border-primary data-checked:bg-primary/5 cn-questionnaire-choice group/questionnaire-choice relative flex min-h-11 cursor-pointer items-start text-start transition-colors outline-none select-none',
    ...
    >
      ...
      <span
        ...
        className="mt-0.5 size-4 cn-questionnaire-choice-indicator pointer-events-none relative flex shrink-0 items-center justify-center border group-data-[type=radio]/questionnaire-choice:rounded-full"
      >
        <span
          data-slot="questionnaire-choice-indicator-dot"
          className="size-2 bg-primary cn-questionnaire-choice-indicator-dot hidden rounded-full group-data-[type=checkbox]/questionnaire-choice:hidden group-data-checked/questionnaire-choice:block"
        />
        <CheckIcon
          data-slot="questionnaire-choice-indicator-check"
          className="size-3 cn-questionnaire-choice-indicator-check hidden group-data-[type=radio]/questionnaire-choice:hidden group-data-checked/questionnaire-choice:block"
        />
      </span>
...
function QuestionnaireActions({ className, ...props }: React.ComponentProps<'div'>) {
  return (
    <div
      ...
      className={cn(
        'gap-2 cn-questionnaire-actions grid min-h-11 w-full grid-cols-[minmax(0,1fr)_auto_auto] items-center',
        className,
      )}
      {...props}
    />
